...
* **Real-Time Attendance**: The system connects to CCTV cameras or webcams, scans faces, and automatically marks students as 'Present' or 'Late' if their face matches a registered student.
* **Intruder / Unknown Alerts**: If an unknown person is seen by the cameras, the system captures their snapshot and triggers a warning alert on the dashboard.
